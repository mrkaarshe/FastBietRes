    ...
    >
      ...
      <section className=" mx-auto pt-10 grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-10 items-center">
        <img
          ...
          src={hero}
          alt="Our restaurant"
          className="h-150 w-[900px] rounded-2xl border border-gray-800 object-cover shadow-lg hover:shadow-cyan-500/20 transition"
        />

      <div data-aos="fade-left" className="flex flex-col gap-5">
        <h2 className="text-3xl font-bold text-yellow-500">Our Story</h2>

        <p className="leading-relaxed">
          Founded in 2025,{" "}
          <span className="font-semibold text-yellow-500 font-mono">FastBite</span>{" "}
        ...
        <p className="leading-relaxed">
          But{" "}
          <span className="font-semibold text-yellow-500 font-mono">FastBite</span> is
        ...
        <p className="italic text-gray-400 border-l-4 border-yellow-500 pl-4 mt-3">
      ...
      <section className="w-full py-16">
        <div className=" text-center">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
            ...
            <div
              data-aos="fade-right"
              className="p-8 border border-gray-800 rounded-2xl hover:-translate-y-2 hover:border-white transition duration-300 bg-slate-950/10"
            >
      ...
      <div
        data-aos="zoom-in"
        className="mt-10 max-w-3xl flex flex-col items-center text-center p-10 border-x border-gray-800 rounded-md hover:border-white transition duration-300"
      >
        ...
        <button className="px-10 py-3 bg-yellow-500 hover:bg-transparent hover:border border-yellow-500 text-white rounded-full font-semibold transition">
          Order Now
        </button>
      </div>
    </div>
