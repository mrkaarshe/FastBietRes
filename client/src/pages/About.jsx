...
const About = () => {
  ...
  return (
    ...
    >
      ...
      <section className="w-full py-16">
        <div className=" text-center">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
            ...
            <div
              data-aos="fade-right"
              className="p-8 border border-slate-600 rounded-2xl hover:-translate-y-2 hover:border-white transition duration-300 bg-slate-950/10"
            >
      ...
      <div
        data-aos="zoom-in"
        className="mt-10 max-w-3xl flex flex-col items-center text-centerrounded-2xl p-10 border-x rounded-md hover:border-white transition duration-300"
      >
