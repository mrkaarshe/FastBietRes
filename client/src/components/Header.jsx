...
const Header = () => {
    ...
    return (
        <>
        <div className='py-4 shadow-sm shadow-[#fa961d]  backdrop-blur-xl flex justify-between items-center mx-3 px-10 rounded-lg fixed top-5 right-0 left-0 text-gray-700 font-bold z-100'>
