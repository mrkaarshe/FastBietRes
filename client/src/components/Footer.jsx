...
const Footer = () => {
  return (
    <footer className="bg-slate-900 border-t-2 border-cyan-500 rounded-t-lg shadow-2xl text-gray-300 pt-12">
      <div className=" px-6 grid grid-cols-1 md:grid-cols-3 gap-8">
        {/* About */}
        <div>
          <h2 className="text-xl font-bold text-gray-400 font-bol mb-4">🍴 <span className='text-cyan-500 font-mono'>FastBite</span> Restaurant <span>& Delivery</span></h2>
        ...
        <div>
          ...
          <ul className="space-y-1 text-gray-400 font-bol">
            <li><Link to={'/home'} className="hover:text-cyan-500 text-white  font-mono">Home</Link></li>
            <li><Link  to={'/about'} className="hover:text-cyan-500 text-white  font-mono">About</Link></li>
            <li><Link to={'/menu'}  className="hover:text-cyan-500 text-white  font-mono">Menu</Link></li>
            <li><Link  to={'/contact'} className="hover:text-cyan-500 text-white  font-mono">Contact Us</Link></li>
          </ul>
        </div>
      ...
      {/* Bottom Bar */}
      <div className="border-t-2 font-mono border-cyan-500 mt-10 py-4 text-center text-gray-300 font-bol text-sm">
